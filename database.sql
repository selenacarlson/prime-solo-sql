...
UPDATE accounts SET account_balance=10.0 WHERE account_balance=0 and transactions_attempted=0;
...
-- 8. Add a new record.
INSERT INTO accounts (username, city, transactions_completed, transactions_attempted, account_balance) VALUES ('selena', 'minneapolis', 3, 3, 33.33);
